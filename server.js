...
async function askMiniMax(userId, userMessage) {
    ...
    const body = JSON.stringify({
        model: 'MiniMax-M2',
        messages: [
            { role: 'system', content: `你是萬能科技大學招生處的AI客服助理，請用繁體中文回答，回答要簡潔友善。
...
【學院與系所】
航空暨工程學院：航空光機電系、航空暨運輸服務管理系、車輛工程系、電機工程系、精密機械與工業工程系、電資研究所
觀光餐旅暨管理學院：觀光與休閒事業管理系、旅館管理系、餐飲管理系、行銷與流通管理系暨智慧商務研究所、企業管理系暨研究所
設計學院：商業設計系、室內設計與營建科技系暨研究所、時尚造型設計暨表演藝術系、化妝品應用與管理系暨研究所
資訊學院：資訊工程系暨研究所、資訊管理系暨研究所
...
如不確定的問題，請建議用戶撥打招生專線 03-4515811。` },
            ...aiSessions[userId]
        ]
    });
